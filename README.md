...
To regenerate the Issue #3 evidence outputs from that release:
...
analysis checks the recorded numerical diagnostics, writes the local ignored
`data/evidence-summary.csv`, and regenerates figures under
`docs/report/figures/`.
